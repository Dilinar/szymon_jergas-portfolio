...
export default {
    ...
    summary: {
        ...
        en: [
            ...
            'But as with every project, I tried to learn something new while working on it. Therefore, I\'ve decided that it should have its place here.'
        ]
    },
    featuresHeader: {
        pl: [
    ...
    features: {
        pl: [
            ...
            'Po trzecie, formularz kontaktowy u dołu strony, który wysyła wiadomość bezpośrednio na mój adres e-mail.'
        ],
        en: [
            'There is not much to talk about when it comes to features. After all, it is a portfolio to show off other projects.',
            'But there are 3 things that none of my other projects have.',
            'Firstly, we have the language selector, allowing to change the language to either Polish or English.',
            'Secondly, the theme selector. This allows to change the theme to dark or bright theme.',
            'Thirdly, the contact form at the bottom, which sends a message directly to my email address.'
        ]
    },
    technologiesHeader: {
        pl: [
    ...
    lessons: {
        ...
        en: [
            ...
            '- Putting together a contact form using the Formspree library and Material UI for form control and styling',
            '- Differentiating between pages and components and dividing them accordingly in the projects file structure'
        ]
    }   
